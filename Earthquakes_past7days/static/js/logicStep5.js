...
// Then we add a control to the map that will allow the users to change 
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
    ...
    L.geoJSON(data, {
        ...
        style: styleInfo, 
        // We creare a popup for each circleMarker to display the magnitude and 
    ...
    // Remove argument "map" from legend function
